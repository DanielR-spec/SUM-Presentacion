...
public class RegistroUsuarios extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * salida.println("<html><Body>"); salida.println("Tipo de cuenta: " +
		 * request.getParameter("account")); salida.print("<div></div>");
		 * salida.println("Nombre introducido: " + request.getParameter("nombre"));
		 * salida.print("<div></div>"); salida.println("Correo: " +
		 * request.getParameter("correo")); salida.print("<div></div>");
		...
		// System.out.println(correo+contrase);
