...
import com.modelo.GestorSolicitudes;

/**
 * Servlet implementation class ResponseManager
 */
...
public class ResponseManager extends HttpServlet {
	...
	public int login(String correo, String contraseña) throws NoSuchMethodException, SecurityException{
		...
		// TODO Auto-generated method stub
		if (correo.equalsIgnoreCase("danki")&&contraseña.equalsIgnoreCase("dank")) {
			if (gestorSolicitudes != null) {
				return 5;}
		}else
			return 0;
		return 0;
